...
echo valeur de i %i%...
ffmpeg -ss 00:00:00.001 -i "sons_musique/%%X" -t 00:00:03.001 "sons_musique/extrait%i%.wav"
set /a i+=1)
...
::ffmpeg -ss 00:00:00.001 -t 00:00:03.001 -i "sons_parole/%%Y" -t 00:00:03.001 "sons_parole/extrait%i%.wav"
::set /a i+=1)